...
function peg$parse(input, options) {
    ...
    var peg$e51 = peg$literalExpectation("exists", false);
    ...
    var peg$f0 = function (s) { return s.join(''); };
    ...
    var peg$f7 = function (head, tails) { return [head, ...tails]; };
    var peg$f8 = function (head, s) { return s; };
    var peg$f9 = function (head, tails) { return [head, ...tails]; };
    var peg$f10 = function (head, s) { return s; };
    var peg$f11 = function (head, tails) { return [head, ...tails]; };
    var peg$f12 = function (e) { return e; };
    var peg$f13 = function (name, members) { return createNode('ns', { name, members }); };
    var peg$f14 = function (name, value) { return createNode('meta', { name, value }); };
    var peg$f15 = function (value) { return createNode('meta', { name: null, value }); };
    var peg$f16 = function (name, type, expr) { return createNode('def', { name, varType: type, expr, mut: false, attr: [] }); };
    var peg$f17 = function (name, type, expr) { return createNode('def', { name, varType: type, expr, mut: true, attr: [] }); };
    ...
    var peg$f22 = function (varn, v) { return v; };
    var peg$f23 = function (varn, from_, to, x) {
    ...
    var peg$f24 = function (varn, v) { return v; };
    var peg$f25 = function (varn, from_, to, x) {
        return createNode('for', {
            var: varn,
            from: from_ ?? createNode('num', { value: 0 }),
            to: to,
    ...
    var peg$f28 = function (expr) { return createNode('return', { expr }); };
    var peg$f29 = function (s) { return createNode('loop', { statements: s }); };
    var peg$f30 = function () { return createNode('break', {}); };
    var peg$f31 = function () { return createNode('continue', {}); };
    ...
    var peg$f33 = function (head, op, term) { return { op, term }; };
    ...
    var peg$f38 = function (args) { return createNode('callChain', { args: args ?? [] }); };
    var peg$f39 = function (head, expr) { return expr; };
    var peg$f40 = function (head, tails) { return [head, ...tails]; };
    var peg$f41 = function (index) { return createNode('indexChain', { index }); };
    var peg$f42 = function (name) { return createNode('propChain', { name }); };
    ...
    var peg$f44 = function (head, tails) { return [head, ...tails]; };
    var peg$f45 = function (cond, then) { return { cond, then }; };
    var peg$f46 = function (then) { return then; };
    var peg$f47 = function (about, q, a) { return { q, a }; };
    ...
    var peg$f49 = function (s) { return createNode('block', { statements: s }); };
    var peg$f50 = function (i) { return createNode('exists', { identifier: i }); };
    var peg$f51 = function (name) { return createNode('identifier', { name }); };
    var peg$f52 = function (items) { return createNode('tmpl', { tmpl: items }); };
    var peg$f53 = function (str) { return str.join(""); };
    var peg$f54 = function (c) { return c; };
    var peg$f55 = function (value) { return createNode('str', { value: value.join('') }); };
    var peg$f56 = function (c) { return c; };
    var peg$f57 = function (value) { return createNode('str', { value: value.join('') }); };
    var peg$f58 = function () { return '"'; };
    var peg$f59 = function () { return '\''; };
    var peg$f60 = function () { return createNode('num', { value: parseFloat(text()) }); };
    var peg$f61 = function () { return createNode('num', { value: parseFloat(text()) }); };
    var peg$f62 = function () { return createNode('num', { value: parseInt(text(), 10) }); };
    var peg$f63 = function () { return createNode('num', { value: parseInt(text(), 10) }); };
    var peg$f64 = function () { return createNode('bool', { value: true }); };
    var peg$f65 = function () { return createNode('bool', { value: false }); };
    var peg$f66 = function () { return createNode('null', {}); };
    var peg$f67 = function (k, v) { return { k, v }; };
    var peg$f68 = function (kvs) {
        const obj = new Map();
        for (const kv of kvs) {
            obj.set(kv.k, kv.v);
        }
    ...
    var peg$f69 = function (item) { return item; };
    var peg$f70 = function (items) { return createNode('arr', { value: items }); };
    var peg$f71 = function (name, type) { return { name, argType: type }; };
    var peg$f72 = function (head, tails) { return [head, ...tails]; };
    var peg$f73 = function (s1, name, s2, args, ret, content) {
    ...
    var peg$f74 = function (args, ret, content) { return createNode('fn', { args: args ?? [], retType: ret }, content ?? []); };
    var peg$f75 = function (item) { return item; };
    var peg$f76 = function (items) { return createNode('arr', { value: items }); };
    var peg$f77 = function (k, v) { return { k, v }; };
    var peg$f78 = function (kvs) {
        const obj = new Map();
        for (const kv of kvs) {
            obj.set(kv.k, kv.v);
        }
    ...
    var peg$f79 = function (args, result) { return createNode('fnTypeSource', { args: args ?? [], result }); };
    var peg$f80 = function (head, tails) { return [head, ...tails]; };
    var peg$f81 = function (name, inner) { return createNode('namedTypeSource', { name, inner }); };
    var peg$f82 = function (name) { return createNode('namedTypeSource', { name, inner: null }); };
    var peg$f83 = function () { return text(); };
    var peg$f84 = function () { return text(); };
    var peg$f85 = function (s) { return createNode('block', { statements: (s ?? []) }); };
    var peg$currPos = 0;
    var peg$savedPos = 0;
                ...
                if (s5 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                        ...
                        if (s12 !== peg$FAILED) {
                            ...
                            if (s16 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s0 = peg$f73(s2, s3, s4, s7, s10, s14);
                            }
                            else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
