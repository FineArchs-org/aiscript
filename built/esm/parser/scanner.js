...
export class Scanner {
    ...
    */
        ...
        while (true) {
            ...
            switch (this.stream.char) {
                ...
                case '#': {
                    ...
                    else if (!this.stream.eof && this.stream.char === '[') {
                        this.stream.next();
    ...
    readStringLiteral(hasLeftSpacing) {
        let value = '';
