...
export function parseDefStatement(s) {
    switch (s.kind) {
        case TokenKind.VarKeyword:
        case TokenKind.LetKeyword: {
            return parseVarDef(s);
 ...
 * ```
*/
export function parseBlockOrStatement(s) {
    const loc = s.token.loc;
 ...
 * ```
*/
function parseStatementWithAttr(s) {
    const attrs = [];
 ...
 * ```
*/
function tryParseAssign(s, dest) {
    const loc = s.token.loc;
    // Assign
    switch (s.kind) {
        case TokenKind.Eq: {
